        ...
        methods: { 
            ...
            getData: function (value) {
                ...
                .then (function(res){
                    ...
                    console.log('input:  ' + self.input + " (TxProviderTypeAhead)");
                    console.log('Results found:  ' + self.list.length + " (TxProviderTypeAhead)")

                }).catch(function(error){
                    console.log('error:  ' + error + " (TxProviderTypeAhead)");
                })
            },
			setInputDisplay: function () {
                console.log("setInputDisplay:  TxProviderTypeAhead ");
                var selected = this.list[this.selectedIndex];
                var value = selected.profile.last_name  + ", " + selected.profile.first_name + " " + 
                        + selected.npi;
                this.input = value;
            },
			setSummaryDisplay: function () {
                console.log("setSummaryDisplay:  TxProviderTypeAhead");
                ...
                if(this.selected.profile.languages){
                    ...
                    this.selected.profile.languages.forEach(element => {
                        languages ==="" ? languages = element.name : languages += ", " + element.name
                    });
